...
export const Route = createFileRoute('/history/detail/$id')({
    component: RouteComponent,
})

function RouteComponent() {
    const { id } = useParams({ from: "/history/detail/$id" });
                ...
                <CardContent className="p-6">
                    ...
                    <div className="grid grid-cols-2 gap-x-8 gap-y-3 text-sm sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <span
                                className={`font-medium tabular-nums ${record.correctCount === record.totalCount
                                    ? "text-green-600"
                                    : ""
                                    }`}
                            >
                    ...
                    <div className="space-y-1 rounded-lg border">
                        {record.details.map((d, i) => (
                            ...
                            >
                                ...
                                <span
                                    className={`w-20 text-right font-mono text-xs sm:text-sm ${d.isCorrect ? "text-green-600" : "text-red-600"
                                        }`}
                                >
                                    {d.userAnswer || "—"}
                                </span>
